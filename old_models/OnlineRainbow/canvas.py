...
class Canvas:
    ...
    def step(self, visible, idx, path, acts, score, steps, walls, ep):
        ...
        self.placeCells()
        self.draw_visible(acts, steps, walls, ep)
    ...
    def draw_visible(self, acts, steps, walls, ep):
        ...
        self.surface.blit(self.font.render('Episode: ' + str(ep), True, (0, 0, 0)),
                          (1100, 40))
        self.surface.blit(self.font.render(f'Frame: {str(ep)}/ 20000', True, (0, 0, 0)),
                          (1100, 70))
